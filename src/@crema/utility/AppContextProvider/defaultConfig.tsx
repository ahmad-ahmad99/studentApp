import { Fonts, FooterType, HeaderType, LayoutDirection, LayoutType, MenuStyle, NavStyle, RouteTransition, ThemeMode, ThemeStyle, ThemeStyleRadius } from 'shared/constants/AppEnums';
...
export const defaultTheme: any = {
  theme: {
    ...
    typography: {
      fontFamily: ['Work Sans', 'Poppins', 'sans-serif'].join(','),
      fontSize: 14,
      fontWeight: 400,
      h1: {
        fontSize: 22,
...
export const LightSidebar: SidebarData = {
  sidebarBgColor: '#fff',
  sidebarTextColor: '#202020',
  sidebarHeaderColor: '#fff',
  sidebarMenuSelectedBgColor: '#edf4fe',
  sidebarMenuSelectedTextColor: '#202020',
  mode: ThemeMode.LIGHT,
};
const defaultConfig = {
  sidebar: {
